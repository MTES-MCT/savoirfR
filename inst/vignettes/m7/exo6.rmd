...
```{r mod7_exo2_part01_solution, message=FALSE, warning=FALSE}
library(tidyverse)
library(tmap)
library(variousdata)
library(sf)
...
```{r mod7_exo2_part02_solution, message=FALSE, warning=FALSE}
...
```{r mod7_exo2_part03_solution, message=FALSE, warning=FALSE}
...
```{r mod7_exo2_part04_solution, message=FALSE, warning=FALSE}
bbox_africa <- World %>%
...
```{r mod7_exo2_part05_solution, message=FALSE, warning=FALSE}
ggdraw() +
