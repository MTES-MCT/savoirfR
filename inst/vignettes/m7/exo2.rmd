...
```{r mod7_exo2_part01, message=FALSE, warning=FALSE}
...
```{r mod7_exo2_part02, message=FALSE, warning=FALSE}
...
```{r mod7_exo2_part03, message=FALSE, warning=FALSE}
library(lubridate)
...
Résultat attendu : 
```{r mod7_exo2_part04, message=FALSE, warning=FALSE}
# Volume des ventes
indicateurs1 <- stat %>%
