...
```{r mod7_exo1_part01_solution, message=FALSE, warning=FALSE}
library(httr)
library(jsonlite)
library(sf)
library(tidyverse)
...
```{r mod7_exo1_part02_solution, message=FALSE, warning=FALSE}
...
```{r mod7_exo1_part03_solution, message=FALSE, warning=FALSE}
...
```{r mod7_exo1_part04_solution, message=FALSE, warning=FALSE}
...
Résultat intermédiaire : 
```{r mod7_exo1_part05_solution, message=FALSE, warning=FALSE}
indicateurs1 <- stat %>%
...
```{r mod7_exo1_part06_solution, message=FALSE, warning=FALSE}
ggplot() +
  geom_sf(
    data = indicateurs %>%
...
```{r mod7_exo1_part07_solution, message=FALSE, warning=FALSE}
ggplot() +
  geom_sf(
    data = indicateurs %>%
      filter(annee_mutation == 2018),
