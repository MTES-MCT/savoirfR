...
```{r setup M6_exo5, eval=FALSE, echo=TRUE}
...
```{r, setup H exo5, eval=TRUE, echo=FALSE}
H <- 800
```
...
knitr::include_url(url = "https://mtes-mct.github.io/savoirfR/cheesedown/cheesedown_exo5.html", height = H)
```