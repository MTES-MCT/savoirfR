...
# -   Créer un chunk pour définir des options générales (par exemple pour masquer les warnings dans le document produit), il ne doit pas être visible dans le document final. 
