...
**Exception** : les corrections du module 6 Publications avec Rmarkdown sont des fichiers entiers, on ne peut pas suivre le même process. 
Les Rmd de correction sont à placer directement dans `inst/rstudio/templates/project/ressources/m6/corrections`. 
Le résultat est présenté dans le support de court ou dans le site de savoirfR par e-frame depuis <https://mtes-mct.github.io/savoirfR/cheesedown/>.  
